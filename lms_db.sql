...
MySQL - 10.4.20-MariaDB : Database - lms_db
*********************************************************************
*/
...
CREATE TABLE `task` (
  ...
  `task_from_res` int(11) NOT NULL DEFAULT 0,
  `task_complain_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `task_assigned` int(11) DEFAULT NULL,
  `duplicate_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `task_expire` datetime DEFAULT NULL,
